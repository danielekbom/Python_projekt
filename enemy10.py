...
class Enemy10:
	...
	def __init__(self):
		self.ball = Image(Point(1400,random.randint(50,580)),"images/enemy10/1.gif")
		self.currentImage = itertools.cycle('1')
	...
	def nextImage(self):
		self.ball.undraw()
		self.ball = Image(self.getCenter(),"images/enemy10/" + next(self.currentImage) +  ".gif")
